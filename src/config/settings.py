...
FILE_WRITE_ENABLED = env_bool("LEARN_AGENT_FILE_WRITE_ENABLED", True)
COMMAND_WRITE_ENABLED = env_bool("LEARN_AGENT_COMMAND_WRITE_ENABLED", False)
FILE_WRITE_MAX_BYTES = env_int("LEARN_AGENT_FILE_WRITE_MAX_BYTES", 1_048_576)
FILE_OPERATION_MAX_ENTRIES = env_int("LEARN_AGENT_FILE_OPERATION_MAX_ENTRIES", 100)
COMMAND_CHANGESET_MAX_FILES = env_int("LEARN_AGENT_COMMAND_CHANGESET_MAX_FILES", 100)
COMMAND_CHANGESET_MAX_BYTES = env_int(
    "LEARN_AGENT_COMMAND_CHANGESET_MAX_BYTES", 10_485_760
)
CONTROLLED_EXECUTION_LIMIT_ENABLED = env_bool(
    "LEARN_AGENT_CONTROLLED_EXECUTION_LIMIT_ENABLED", False
)
...
CONTEXT_SAFETY_MARGIN_TOKENS = env_int(
    "LEARN_AGENT_CONTEXT_SAFETY_MARGIN_TOKENS", 8_192
)
CONTEXT_SOFT_LIMIT_RATIO = env_float(
    "LEARN_AGENT_CONTEXT_SOFT_LIMIT_RATIO", 0.85
)
...
if not 0 < RECENT_TURN_BUDGET_RATIO <= 0.5:
    raise ValueError(
        "LEARN_AGENT_RECENT_TURN_BUDGET_RATIO must be greater than 0 and at most 0.5"
    )
...
if LLM_MAX_TOKENS + CONTEXT_SAFETY_MARGIN_TOKENS >= MODEL_CONTEXT_LIMIT:
    raise ValueError(
        "LEARN_AGENT_LLM_MAX_TOKENS plus the context safety margin must be "
        "smaller than LEARN_AGENT_MODEL_CONTEXT_LIMIT"
    )
...
# Durable, frontend-neutral resource activity ledger.
RESOURCE_ACTIVITY_ENABLED = env_bool("LEARN_AGENT_RESOURCE_ACTIVITY_ENABLED", True)
RESOURCE_ACTIVITY_HASH_ENABLED = env_bool("LEARN_AGENT_RESOURCE_ACTIVITY_HASH_ENABLED", True)
RESOURCE_ACTIVITY_MAX_ITEMS_PER_EXECUTION = env_int(
    "LEARN_AGENT_RESOURCE_ACTIVITY_MAX_ITEMS_PER_EXECUTION", 1000
)
