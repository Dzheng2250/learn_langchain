...
from src.core.llm.usage import context_tokens, has_context_usage
...
class TurnFinalizer:
    ...
    def finalize(
        ...
        *,
        ...
        # Persist the provider-reported total from the latest parent LLM call.
        if has_context_usage(usage):
            fast_state.context_tokens = context_tokens(usage)
