    ...
    *,
    ...
    if task_planning_enabled:
        task_policy = (
            ...
            "verification-heavy, review, refactor, or resume-prone work. Do not "
            "create a task plan for simple single-step requests. For complex "
            "goals, create a task_plan before broad inspection, delegation, "
            "multi-file reading, or command execution. Do not make "
            "delegate_to_subagent your first tool for a complex goal; first create "
            "a compact plan that names the scope, evidence gathering, analysis, "
            "and final reporting tasks. Use semantic task_key values such as "
            ...
            "in_progress; when it is done, mark it completed. If delegating a "
            "planned task, mention the relevant task_key in the delegation "
