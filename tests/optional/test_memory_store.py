...
RUN_POSTGRES_INTEGRATION = os.getenv(
    "LEARN_AGENT_RUN_POSTGRES_INTEGRATION_TESTS",
    "",
...
@unittest.skipUnless(
    ...
    "requires LEARN_AGENT_RUN_POSTGRES_INTEGRATION_TESTS=1 and a reachable PostgreSQL",
)
class WorkspaceMemoryStoreTest(unittest.TestCase):
    """Exercise the optional PostgreSQL projection against a real database."""
